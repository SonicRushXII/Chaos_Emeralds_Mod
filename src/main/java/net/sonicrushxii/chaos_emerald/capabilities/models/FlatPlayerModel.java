package net.sonicrushxii.chaos_emerald.capabilities.models;// Made with Blockbench 4.11.1
...
public class FlatPlayerModel<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(ChaosEmerald.MOD_ID, "player_base_model"), "main");
	...
	public FlatPlayerModel(ModelPart root) {
