package net.sonicrushxii.chaos_emerald.entities.false_super;// Made with Blockbench 4.11.2
...
public class ChaosSpazModel<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(ChaosEmerald.MOD_ID, "false_super_chaos_spaz"), "main");

	public static final ModModelRenderer.Texture[] TEXTURE_LOCATIONS = {
			new ModModelRenderer.Texture("textures/custom_model/false_super/chaos_spaz.png",(byte)0)
	};
	...
	public ChaosSpazModel(ModelPart root) {
